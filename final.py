...
imageDir = "D:\Ritika Agarwal\ImageProcessing_Project\ImageProcessing_Project\images1"
image_path_list = []
...
for imagePath in image_path_list:
    ...
    smoothed = cv2.dilate(thresh,Kernel,iterations = 2)
    #smoothed = cv2.GaussianBlur(thresh,(3,3),0)
    #smoothed = cv2.dilate(thresh,None,iterations = 3)
    smoothed_1 = cv2.erode(smoothed,None,iterations =2)
